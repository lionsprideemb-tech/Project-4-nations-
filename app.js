...
const creatorSuggestions={
 gender:['Woman','Man','Nonbinary','Genderfluid','Agender','Questioning'],
 pronouns:['she/her','he/him','they/them','she/they','he/they','any pronouns'],
 height:["5'2\" / 157 cm","5'5\" / 165 cm","5'8\" / 173 cm","5'10\" / 178 cm","6'0\" / 183 cm","6'3\" / 191 cm"],
 skin:['Very fair','Fair','Light olive','Warm tan','Medium brown','Deep brown','Dark brown','Copper-toned'],
 eyes:['Brown','Dark brown','Hazel','Green','Gray','Blue','Amber'],
 hairColor:['Black','Dark brown','Brown','Auburn','Red','Blond','Gray','White'],
 hairStyle:['Short and practical','Shoulder-length and loose','Long braid','Twin braids','Topknot','Shaved sides with long top','Messy curls','Straight waist-length hair','Close cropped','Half-up style'],
 face:['Soft round features','Angular face and strong jaw','High cheekbones','Freckles across the nose','Heavy brows and intense eyes','Gentle features','Weathered face','Sharp nose and narrow eyes'],
 marks:['No distinguishing marks','Small eyebrow scar','Scar across one cheek','Burn scar on one arm','Birthmark on neck','Traditional family tattoo','Old training scars','Pierced ears'],
 clothing:['Practical nation-colored work clothes','Traditional layered robes','Travel-worn practical clothing','Modern city clothing','Martial training clothes','Merchant-quality fashionable clothes','Simple rural clothing','Formal family attire'],
 goals:['Open my own tea house','Become a respected healer','Master my bending without becoming famous','Travel beyond my home region','Support my family financially','Become a skilled artisan','Teach younger benders','Build a quiet family life','Become a respected community leader','Discover what I actually want from life','Start a successful business','Become a professional fighter','Join public service','Study spirits and old traditions'],
 fears:['Disappointing my family','Being abandoned','Losing control of my bending','Deep water','Heights','Spirits','Being trapped in my hometown forever','Failing publicly','Becoming like one of my parents','Losing someone I love','War returning','Never becoming good at anything','Being financially dependent on others','Being forgotten'],
 background:['I owe someone money and they have started asking for it back.','My sibling left home and stopped writing.','My family expects me to inherit the family business.','I secretly want to leave town, but nobody knows yet.','I had a falling out with my closest friend and never repaired it.','I promised someone I would accomplish something important for them.','My family has an old reputation I do not know whether I want.','I witnessed something strange involving a spirit and never told anyone.','I failed an important training exam and still feel embarrassed about it.','Someone helped me years ago and I still owe them a favor.','I am saving money for a life my family does not understand.','I recently ended a relationship and still see that person around town.']
};
...
function newWorld(){
  ...
  world={ schemaVersion:53,id:uid(),name,era,historyMode,createdAt:new Date().toISOString(),lastSavedAt:null,clock:{year:initialYear(era),seasonIndex:0,day:1,hour:7},environment:{weather:'Clear'},characters:[],activeCharacterId:null,npcs:[
